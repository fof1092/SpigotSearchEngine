...
class SSEGuiManager {
  ...
  static showCategories() {
    ...
    let types = [
      ...
      { type: 'CategorieSpigot', text: ' Spigot' },
      { type: 'CategorieSkript', text: ' Skript' },
      { type: 'CategorieBungeecord', text: ' Bungeecord' },
      { type: 'CategorieSpigotBungeecord', text: ' Bungeecord - Spigot' },
  ...
  static showSearchType() {
    ...
    document.getElementById(SSEGuiManager.getSearchTypeByID(SSELocalStorag.getItem('SearchType'))).checked = true;
  }
  ...
  static showSortByBox() {
    ...
    for (let categorie of types) {
      ...
      bntSortBy.onclick = function() {
        SSELocalStorag.setItem('SortBy', SSEGuiManager.getSortByName(categorie['type']));
  ...
  static setSortByBoxButtonColor() {
    ...
    for (let categorie of types) {
      ...
      if (SSEGuiManager.getSortByID(SSELocalStorag.getItem('SortBy')) == categorie['type']) {
